        ...
        <div className="sticky-header-container" style={{ position: 'static', paddingBottom: '0px' }}>
          <div className="pos-header-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
              ...
              <button onClick={() => setShowTreasuryModal(true)} style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(56, 189, 248, 0.1)', border: '1px solid #38bdf8', color: '#38bdf8', padding: '8px 15px', borderRadius: '20px', cursor: 'pointer', fontWeight: 'bold' }}>
